...
use crate::{CHIP8Input, InputKey};

const SCALING: u64 = 10;

pub fn drive(program: &[u8]) -> Result<(), Error> {
    ...
    let mut cinput = CHIP8Input { pressed_keys: [false;16], released_key: None }; 
    ...
    event_loop.run(move |event, _, control_flow| {
        ...
        if loop_speed_limit_instant.elapsed() >= Duration::from_micros(1430) {
